...
prelim_results <- prelim_results %>%
  filter(!name %in% participants_to_exclude)
ggplot(prelim_results, aes(x = Date, y = steps, group = participant_id, color = treatment)) +
  geom_point() +
  labs(title = "Steps Over Time by Treatment Week, Faceted by Treatment Condition",
       x = "Date",
